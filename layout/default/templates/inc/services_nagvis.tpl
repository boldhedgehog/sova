        ...
        {if $nagios_service}
            ...
            <div id="nagvisServiceIcon{$service_key}" class="nagvisServiceIcon nagvisServiceIcon{$nagios_service.state}" style="top:{$service.y}px;left:{$service.x}px">
                ...
                <table cellspacing="0" cellpadding="1" border="1">
                    ...
                    <tr><td class="caption">Тривалість</td><td>{if isset($nagios_service.state_duration) and $nagios_service.state_duration}{$nagios_service.state_duration|human_interval}{/if}</td></tr>
